...
################################################################
# This is a generated script based on design: pynqZ2_comblock_bd
#
...
# source pynqZ2_comblock_bd_script.tcl
...
set design_name pynqZ2_comblock_bd
...
proc create_hier_cell_Led_RGB_4_5 { parentCell nameHier } {
  ...
  connect_bd_net -net rgb_1_Dout [get_bd_pins rgb_1/Dout] [get_bd_pins led4_g]
  connect_bd_net -net rgb_2_Dout [get_bd_pins rgb_2/Dout] [get_bd_pins led4_b]
  connect_bd_net -net rgb_3_Dout [get_bd_pins rgb_3/Dout] [get_bd_pins led4_r]
  connect_bd_net -net rgb_4_Dout [get_bd_pins rgb_4/Dout] [get_bd_pins led5_g]
  connect_bd_net -net rgb_5_Dout [get_bd_pins rgb_5/Dout] [get_bd_pins led5_b]
...
\
  ...
  set_property CONFIG.FIFO_IN_DWIDTH {32} $comblock_0
  ...
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins c_counter_binary_32bits/Q] [get_bd_pins util_vector_logic_xor/Op2] [get_bd_pins comblock_0/fifo_data_i]
  ...
  connect_bd_net -net constant_0_fifo_clear_dout [get_bd_pins constant_0_fifo_clear/dout] [get_bd_pins comblock_0/fifo_clear_i]
  connect_bd_net -net constant_1_we_dout [get_bd_pins constant_1_we/dout] [get_bd_pins comblock_0/ram_we_i] [get_bd_pins comblock_0/fifo_we_i]
  ...
  connect_bd_net -net rgb_1_Dout [get_bd_pins Led_RGB_4_5/led4_g] [get_bd_ports led4_g]
  connect_bd_net -net rgb_2_Dout [get_bd_pins Led_RGB_4_5/led4_b] [get_bd_ports led4_b]
  connect_bd_net -net rgb_3_Dout [get_bd_pins Led_RGB_4_5/led4_r] [get_bd_ports led4_r]
  connect_bd_net -net rgb_4_Dout [get_bd_pins Led_RGB_4_5/led5_g] [get_bd_ports led5_g]
  connect_bd_net -net rgb_5_Dout [get_bd_pins Led_RGB_4_5/led5_b] [get_bd_ports led5_b]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins constant_0_bits/dout] [get_bd_pins xlconcat_0/In2]
