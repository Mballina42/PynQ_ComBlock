...
#
# prj_pynq_z2_comblock.tcl: Tcl script for re-creating project 'prj_pynq_z2_comblock'
#
# Generated by Vivado on Sun Jun 30 12:17:14 +0200 2024
...
#
# 1. This project restoration tcl script (prj_pynq_z2_comblock.tcl) that was generated.
#
...
#
#    "C:/Users/GeoToj/Documents/Gits/PynQ_ComBlock/Constraint/PYNQ-Z2 v1.0.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Constraint/PYNQ-Z2 v1.0.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "prj_pynq_z2_comblock"
...
set script_file "prj_pynq_z2_comblock.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/prj_pynq_z2_comblock"]"
...
set_property -name "top" -value "pynqZ2_comblock_bd_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../Constraint/PYNQ-Z2 v1.0.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../Constraint/PYNQ-Z2 v1.0.xdc"
...
# Proc to create BD pynqZ2_comblock_bd
proc cr_bd_pynqZ2_comblock_bd { parentCell } {
...
# End of cr_bd_pynqZ2_comblock_bd()

cr_bd_pynqZ2_comblock_bd ""
set_property REGISTERED_WITH_MANAGER "1" [get_files pynqZ2_comblock_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files pynqZ2_comblock_bd.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list pynqZ2_comblock_bd.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/prj_pynq_z2_comblock/prj_pynq_z2_comblock.gen/sources_1/bd/pynqZ2_comblock_bd/hdl/pynqZ2_comblock_bd_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list pynqZ2_comblock_bd.bd]] -top]
